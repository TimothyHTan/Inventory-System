      ...
      <PageTransition>
        <main className="max-w-xl mx-auto px-4 sm:px-6 py-8">
          ...
          <div className="card p-6">
            ...
            {/* Helper text — references the paper migration */}
            <div className="mt-6 pt-4 border-t border-carbon-700/30">
              <p className="text-[10px] text-carbon-500 leading-relaxed">
                <span className="text-carbon-400 font-medium">Tip:</span>{" "}
                Lihat sisa terakhir (SISA) di kartu stock kertas, lalu
                masukkan angka tersebut sebagai Stok Awal. Mulai catat
                transaksi baru secara digital dari sini.
              </p>
            </div>
          </div>
        </main>
